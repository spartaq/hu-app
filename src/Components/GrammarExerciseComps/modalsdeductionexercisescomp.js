...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/modalsdeduction.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const ModalsdeductionExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of words.</p>
...
export default ModalsdeductionExercises;
