...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/eding.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const Edingexercisescomp = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          ...
          <div className="exercises-container">
            ...
            <div className="exercisectrl">
              ...
              <div className="filter-dropdown-container">
                <Select
                  ...
                  options={[{ label: 'All Topics', value: null }, ...uniqueTopics]} // Added unique topics
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of the future tense.</p>
...
export default Edingexercisescomp;
