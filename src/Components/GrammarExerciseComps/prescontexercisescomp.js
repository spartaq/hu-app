...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/presentcontinuous.json';
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of the present continuous.</p>
