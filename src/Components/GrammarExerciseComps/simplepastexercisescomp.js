...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/simplepast.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const SimplepastExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of the past.</p>
...
export default SimplepastExercises;
