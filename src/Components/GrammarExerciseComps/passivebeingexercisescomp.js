...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/passivebeing.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const Passivebeingexercises = () => {
      ...
      <div className="grammar-comp-container">
        ...
        <div className="introtext">
          ...
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences below using being, having been based on the prompts.</p>
              ...
              {displayedSentences.map((sentence, index) => (
                <div key={index} className="sentence-container">
                  ...
                  <input
                    ...
                    size={showAnswers ? sentence.answer.length : Math.max(answers[index]?.length || 1, 30)} // Adjust size dynamically
                  />
...
export default Passivebeingexercises;