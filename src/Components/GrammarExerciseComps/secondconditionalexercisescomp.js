...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/secondconditional.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const SecondconditionalExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of Second conditional If + past, would verb.</p>
...
export default SecondconditionalExercises;
