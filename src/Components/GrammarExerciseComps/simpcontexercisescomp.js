...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/simpcont.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const SimpcontExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of the present continuousor simple present.</p>
...
export default SimpcontExercises;
