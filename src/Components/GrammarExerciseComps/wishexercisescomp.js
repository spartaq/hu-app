...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/wish.json';
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          ...
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences below based on the prompts.<br></br><br></br>
            <strong>Subj + wish + subj + had + 3rd form</strong><br></br><br></br>
            <strong>If + subj + had + 3rd form, subj + would + have + 3rd form</strong><br></br><br></br>
            <strong>subj = I, you, he, she, it, we, they, etc.</strong></p>
