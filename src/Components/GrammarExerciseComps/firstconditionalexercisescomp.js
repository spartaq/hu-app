...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/firstconditional.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const FirstconditionalExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of First conditional If + will.</p>
...
export default FirstconditionalExercises;
