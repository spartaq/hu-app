...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/reportedspeech.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const ReportedspeechExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of reported speech.</p>
...
export default ReportedspeechExercises;
