...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/presentperfect.json';
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of the present perfect.</p>
...
export default PresentperfectExercises;
