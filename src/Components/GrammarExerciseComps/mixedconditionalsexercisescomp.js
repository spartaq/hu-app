...
import sentencesData from '../../Mainpages/Grammar-Exercises/Data/mixedcondprod.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const Mixedcondexercises = () => {
              ...
              {displayedSentences.map((sentence, index) => (
                <div key={index} className="sentence-container">
                  ...
                  <input
                    ...
                    size={Math.max(10, (showAnswers ? sentence.answer.length : answers[index]?.length || 0))}
                  />
...
export default Mixedcondexercises;
