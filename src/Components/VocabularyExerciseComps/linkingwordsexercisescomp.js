...
import sentencesData from '../../Mainpages/Vocabulary-Exercises/Data/linkingwords.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const LinkingwordsExercises = () => {
    ...
    <div>
      <div className="grammar-comp-container">
          ...
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct word.</p>
...
export default LinkingwordsExercises;
