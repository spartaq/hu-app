...
import sentencesData from '../../Mainpages/Vocabulary-Exercises/Data/collocations1.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const CollocationsExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with collocations from the box.</p>
...
export default CollocationsExercises;
