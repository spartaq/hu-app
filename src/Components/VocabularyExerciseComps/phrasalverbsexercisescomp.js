...
import sentencesData from '../../Mainpages/Vocabulary-Exercises/Data/phrasalverbs.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const Phrasalverbsexercise = ({ topic }) => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct phrasal verb.</p>
...
export default Phrasalverbsexercise;
