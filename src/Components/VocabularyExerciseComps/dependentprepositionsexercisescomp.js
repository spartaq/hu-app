...
import sentencesData from '../../Mainpages/Vocabulary-Exercises/Data/dependentpreps.json';
import PageCounter from '../../Utils/pagecounter';
import { FaQuestionCircle } from "react-icons/fa";

const DependentprepositionsExercises = () => {
      ...
      <div className="grammar-comp-container">
        <div className="introtext">
          <div className="exercises-container">
            ...
            <p className="descriptionbox">Complete the sentences with the correct form of dependent prepositions.</p>
...
export default DependentprepositionsExercises;
