...
<div>
  ...
  <h3>Structure</h3>
  <p><strong>If + present simple, will + base verb</strong></p>
  <p>We use the present simple after <strong>if</strong>, and <strong>will</strong> + verb in the main clause.</p>

  <p><strong>Example structure:</strong></p>
  <ul>
    <li>If + present simple, will + verb</li>
    <li>If it rains, we will stay at home.</li>
    <li>If I study hard, I will pass the exam.</li>
    <li>If they don't hurry, they will miss the bus.</li>
  </ul>
