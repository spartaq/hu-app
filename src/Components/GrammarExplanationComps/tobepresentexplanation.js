...
<div>
            ...
            <p>We can use the present simple of the verb <strong>to be</strong> to talk about situations and states in the present.</p>
    ...
    <td>
      <ul> 
        ...
        <li>Are they?</li>
            ...
            <p><em>Note that with short answers, we only use contractions with no answers.</em></p>
