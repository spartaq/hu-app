...
import VocabularyExercises from '../../Components/GrammarExerciseComps/wordformsexercisescomp.js';
import VocabularyExplanation from '../../Components/GrammarExplanationComps/wordformsexplanation.js';
...
const [isGrammarVisible, setIsGrammarVisible] = useState(true);
  ...
  return (
    <div>
      <SEO
        title="Vocabulary Exercises - Word Forms"
      ...
      <div className="grammar-container">
          ...
          <div className="grammartitle">
              ...
              <h3 className="mt-2">Word Forms</h3>
            </div>
