...
import exambooks from '../../Images/office-space-michael-bolton.gif';
import { FaAngleDown } from "react-icons/fa";
import RelatedExercises from '../../Utils/relatedExercises.js';
import GrammarExercises from '../../Components/GrammarExerciseComps/relativeclauseexercisescomp.js';
import GrammarExplanation from '../../Components/GrammarExplanationComps/relativeclauseexplanation.js';
    ...
    <div>
      ...
      <div className="grammar-container">
          ...
          <div className="grammartitle">
              ...
              <h3 className="mt-2">Relative Clauses</h3>
            </div>
