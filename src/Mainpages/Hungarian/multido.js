...
import GrammarExercises from './HungarianExerciseComps/multidoexercisescomp.js';
import GrammarExplanation from './HungarianExplanations/multidoexplanation.js';
...
const MultIdo = () => {
  ...
  return (
    <div>
      <SEO
        title="Hungarian Grammar Exercises - Mult Idő"
      ...
      <div>
        <div className="grammartitle">
            ...
            <h3 className="mt-2">Mult Idő (Simple Past)</h3>
          </div>
        ...
        {isVocabVisible ? 'Vocab' : 'Vocab'}<FaAngleDown /></div>
          ...
          {isVocabVisible && (
            <div>
             <ExerciseRouter type="vocab" subtype="mult" />
            </div>
          )} 
        ...
        {isExercisesVisible ? 'Exercises' : 'Exercises'}<FaAngleDown /></div>
          ...
          {isExercisesVisible && (
            <div className="agenda-display-grid">
              <ExerciseRouter type="quiz" subtype="past" />
            </div>
          )} 
...
import GrammarExplanation from './HungarianExplanations/multidoexplanation';
import mainimage from '../../Images/jelenido1.jpg';

const sections = [
  { label: "Vocab", description: "Do this exercise to practice vocab.", type: "vocab", subtype: "verbs" },
  { label: "Exercises", description: "Do this exercise to practice your grammar.", type: "quiz", subtype: "multido" },
