...
const Corruption = () => {
    ...
    return (
        <div>
            <SEO
                title='Exam Topics - Corruption - English Exam Exercises'
                description='A group of English exam exercises centered around the topic of the new year'
                name='English Exam Exercises - Corruption'
                type='article' 
            />

            <div className="agenda-container">
                <div className="agenda-title">
                    <h1 className="mt-2">Corruption</h1>
                </div>
                ...
                <div className="agenda-subtitle">Warmer</div>
                        ...
                        <ImageCarousel data={carouselData} topic="corruption" />
                        </div>
