...
import quizzesData from '../Quizzes/Data/sportsquiz.json';
...
const Sports = () => {
    ...
    return (
        <div>
            <SEO
                title='Exam Topics - Sports - English Exam Exercises'
            ...
            <div className="agenda-container">
                <div className="agenda-title">
                    <h1 className="mt-2">Watching Sports</h1>
                </div>
...
<div>                   
    <div className="agenda-display-grid">
        <VocabularyMatch data={vocabData} topic="sports" />
    </div>                    
</div>
                ...
                <Video videos={videoData} title="Why We Watch Sports" />
                
                <div className="agenda-discussion">Discussion</div>
                <RandomQuestionGenerator discussionquestions={discussionquestionsData} topic="sports" />
            </div>
        </div>
    );
};
