...
import GerundExplanation from '../../Components/GrammarExplanationComps/presentperfectexplanation.js';
...
const BucketList = () => {
    ...
    return (
        <div>
            <SEO
                title='Exam Topics - Bucket List - English Exam Exercises'
                description='A group of English exam exercises centered around the topic of the new year'
                name='English Exam Exercises - Bucket list'
                type='article' 
            />
            ...
            <div className="agenda-container">
                ...
                <div>                   
                <h1 className="mt-2">Bucket List</h1> 
                  </div>  
 ...
 <div className="agenda-quiz">Quiz</div> 
                ...
                <Reading readings={readingcompData} title="Bucket Lists in the U.S." /></div>
                
                <div className="agenda-listening">Video</div>
                             

                <Video videos={videoData} title="Bucketlist" />
                
                <div className="agenda-discussion">Discussion</div>
                <RandomQuestionGenerator discussionquestions={discussionquestionsData} topic="bucketlist" />
            </div>
        </div>
    );
};
