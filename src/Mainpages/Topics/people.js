...
import RelativeclauseExercises from '../../Components/GrammarExerciseComps/relativeclauseexercisescomp.js';
import RelativeclauseExplanation from '../../Components/GrammarExplanationComps/relativeclauseexplanation.js';
...
const People = () => {
    ...
    return (
        <div>
            <SEO
                title='Exam Topics - People - English Exam Exercises'
