...
import quizzesData from '../Quizzes/Data/streamingquiz.json';
...
const StreamingServices = () => {
    ...
    return (
        <div>
            <SEO
                title='Exam Topics - Streaming Services - English Exam Exercises'
                description='A group of English exam exercises centered around the topic of the new year'
                name='English Exam Exercises - Streaming Services'
                type='article' 
            />

            <div className="agenda-container">
                <div className="agenda-title">
                    <h1 className="mt-2">Streaming Services</h1>
                </div>
                ...
                <Reading readings={readingcompData} title="Streaming Fatigue: Too Much of a Good Thing?" />
                </div>
